...
os.mkdir(f'{root_folder}/{folder}/')
os.mkdir(f'{root_folder}/{folder}/hev')
os.mkdir(f'{root_folder}/{folder}/data')
for i in range(num_robots):
    os.mkdir(f'{root_folder}/{folder}/robot_{i}')

config = {
    'num_frames': num_frames,
    'num_robots': num_robots,
}
with open(f'{root_folder}/{folder}/config.json', 'w') as f:
    json.dump(config, f)
...
def scan(client):
    ...
    try:
        ...
        for frame in range(num_frames):
            ...
            bev_image.save(f"{root_folder}/{folder}/hev/{frame}.png")
            ...
            for i, robot in enumerate(robots):
                ...
                robot_image.save(f"{root_folder}/{folder}/robot_{i}/{frame}.png")
            ...
            np.savez_compressed(f'{root_folder}/{folder}/data/{frame}.npz', aux=data)
